...
import 'package:menu_makanan/features/product/presentation/pages/product_list_page.dart';
import 'package:menu_makanan/features/cart/presentation/pages/cart_page.dart'
    as cart_pages;
import 'package:go_router/go_router.dart';
import 'package:menu_makanan/features/profile/presentation/pages/profile_page.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> pages = [
      ...
      cart_pages.HalamanKeranjang(email: widget.email),
